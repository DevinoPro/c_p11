...
public class P11Util {
	...
	public static long GetSlot(PKCS11 pkcs11, boolean private_objects, boolean print_used)
	{
		int islot = 0;
		long[] pslots; 
	...
	public static void Login(PKCS11 pkcs11, long hSession) throws IOException {
		System.out.print("Input Password: ");
		Scanner scan = new Scanner(System.in);
		String passphrase = scan.next();

		try {
			pkcs11.C_Login(hSession, PKCS11Constants.CKU_USER, passphrase.toCharArray());
		} catch (PKCS11Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
